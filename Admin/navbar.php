            ...
            theme: {
                extend: {
                    ...
                    colors: {
                        ...
                        // Map blue and indigo to brand red/maroon shades to dynamically harmonize legacy elements
                        blue: {
                            50: '#fff1f2',
                            100: '#ffe4e6',
                            200: '#fecdd3',
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (sidebar && toggleBtn) {
                    ...
                    function handleSwipeGesture() {
                        ...
                        if (swipeDistance > threshold) {
                            if (touchstartX < edgeThreshold && sidebar.classList.contains('sidebar-hidden')) {
