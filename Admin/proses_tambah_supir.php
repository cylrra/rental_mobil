...
if (isset($_POST['submit'])) {
    ...
    $query_insert = "INSERT INTO supir (id_supir, nama_supir, no_telp, tarif_supir_per_hari, status_supir) 
                     VALUES ('$id_supir', '$nama_supir', '$no_telp', '$tarif_supir_per_hari', '$status_supir')";
